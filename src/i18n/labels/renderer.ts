...
export const RENDERER_LABELS: Record<Locale, {
  ...
  'ja-JP': {
    ...
    editMode: '編集モード',
    addCell: 'セルを追加',
    insertMarkdown: 'マークダウン',
    insertCode: 'コード',
    insertJournal: 'ジャーナル',
    insertCfu: '理解度確認',
    deleteCellTitle: 'セルを削除しますか？',
    deleteCellMessage: 'この操作は元に戻せません。',
    deleteConfirm: '削除',
    editJson: 'JSONを編集',
  },
  'hi-IN': {
    ...
    editMode: 'संपादन मोड',
    addCell: 'सेल जोड़ें',
    insertMarkdown: 'मार्कडाउन',
    insertCode: 'कोड',
    insertJournal: 'जर्नल',
    insertCfu: 'समझ की जांच',
    deleteCellTitle: 'सेल हटाएं?',
    deleteCellMessage: 'यह क्रिया पूर्ववत नहीं की जा सकती।',
    deleteConfirm: 'हटाएं',
  ...
  'fa-IR': {
    ...
    addCell: 'افزودن سلول',
    insertMarkdown: 'مارک‌داون',
    insertCode: 'کد',
    insertJournal: 'یادداشت',
    insertCfu: 'بررسی درک مطلب',
    deleteCellTitle: 'سلول حذف شود؟',
    deleteCellMessage: 'این عمل قابل بازگشت نیست.',
    deleteConfirm: 'حذف',
  ...
  'mn-MN': {
    ...
    addCell: 'Нүд нэмэх',
    insertMarkdown: 'Маркдаун',
    insertCode: 'Код',
    insertJournal: 'Тэмдэглэл',
    insertCfu: 'Ойлголт шалгах',
    deleteCellTitle: 'Нүдийг устгах уу?',
    deleteCellMessage: 'Энэ үйлдлийг буцаах боломжгүй.',
